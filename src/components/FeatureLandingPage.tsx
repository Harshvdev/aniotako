      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start">
          ...
          <div className="space-y-5 w-full mb-10">
            {benefits.map((benefit, idx) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-fuchsia-500/10 to-cyan-500/10 flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform shrink-0 border border-zinc-800/80">
                  {benefit.icon}
                </div>
                <div>
          ...
          <Link
            href={ctaHref}
            className="px-8 py-4 rounded-full bg-gradient-to-r from-fuchsia-600 to-cyan-600 text-white font-bold text-sm uppercase tracking-widest hover:opacity-95 hover:scale-105 active:scale-95 transition-all shadow-[0_0_25px_rgba(217,70,239,0.25)] flex items-center gap-2"
          >
            {ctaText}
        ...
        <div className="lg:col-span-5 flex justify-center items-center relative">
          <div className="w-full max-w-[400px] aspect-square rounded-3xl bg-zinc-900/30 border border-zinc-800/50 backdrop-blur-xl p-8 flex items-center justify-center shadow-2xl relative overflow-hidden group">
            {/* Soft inner glow */}
            <div className="absolute -inset-10 bg-gradient-to-br from-fuchsia-500/5 to-cyan-500/5 opacity-50 blur-2xl group-hover:opacity-100 transition-opacity duration-500" />
